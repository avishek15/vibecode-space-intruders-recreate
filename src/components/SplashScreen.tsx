  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className="relative z-10 text-center max-w-md p-8 rounded-lg">
        <h1 className="text-5xl font-bold mb-6 text-blue-400">Space Invaders</h1>
        <div className="mb-8 space-y-4 text-lg">
          <p>Defend Earth from alien invaders!</p>
          <p>Use <span className="font-bold">← →</span> arrows to move</p>
          <p>Press <span className="font-bold">SPACE</span> to shoot</p>
